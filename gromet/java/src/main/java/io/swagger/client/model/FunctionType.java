 ...
 */
@JsonAdapter(FunctionType.Adapter.class)
public enum FunctionType {
  ...
  public static FunctionType fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<FunctionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FunctionType enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public FunctionType read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return FunctionType.fromValue((String)(value));
    }
  }
}
