...
public class GrometWire extends GrometObject {
  @SerializedName("name")
  ...
  public GrometWire name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GrometWire src(Integer src) {
    this.src = src;
    return this;
  }

   /**
   * Index to the source Port of the Wire.
   * @return src
  **/
  @Schema(description = "Index to the source Port of the Wire.")
  ...
  public GrometWire tgt(Integer tgt) {
    this.tgt = tgt;
    return this;
  }

   /**
   * Index to the target Port of the Wire.
   * @return tgt
  **/
  @Schema(description = "Index to the target Port of the Wire.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GrometWire grometWire = (GrometWire) o;
    return Objects.equals(this.name, grometWire.name) &&
        Objects.equals(this.src, grometWire.src) &&
        Objects.equals(this.tgt, grometWire.tgt) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, src, tgt, super.hashCode());
  }
