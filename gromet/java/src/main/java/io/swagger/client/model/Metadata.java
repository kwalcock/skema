...
/**
 * Placeholder for the Metadata schema (as defined in gromet_metadata_v{VERSION_NUMBER}.yaml). 
 */
@Schema(description = "Placeholder for the Metadata schema (as defined in gromet_metadata_v{VERSION_NUMBER}.yaml). ")
