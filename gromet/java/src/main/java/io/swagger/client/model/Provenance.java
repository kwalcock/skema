 ...
 */
@Schema(description = "Provenance of metadata.")
...
public class Provenance {
  ...
  public Provenance method(String method) {
    this.method = method;
    return this;
  }
   ...
   * @return method
  **/
  @Schema(description = "The inference method (with version) used to derive data. ")
  ...
  public Provenance timestamp(OffsetDateTime timestamp) {
   ...
   * @return timestamp
  **/
  @Schema(description = "Date and time that metadata was generated. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.method, provenance.method) &&
        Objects.equals(this.timestamp, provenance.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(method, timestamp);
  }
