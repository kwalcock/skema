...
/**
 * Provides bookkeeping to associate the update of a Loop parameter (e.g., the iterator variable in a for-loop), which may be specified within the body of the loop, but otherwise independent of the other computation within the loop body. 
 */
@Schema(description = "Provides bookkeeping to associate the update of a Loop parameter (e.g., the iterator variable in a for-loop), which may be specified within the body of the loop, but otherwise independent of the other computation within the loop body. ")
...
public class SourceCodeLoopUpdate extends Metadata {
  @SerializedName("metadata_type")
  private String metadataType = "source_code_loop_update";
  ...
  public SourceCodeLoopUpdate metadataType(String metadataType) {
  ...
  **/
  ...
  public SourceCodeLoopUpdate sourceLanguage(String sourceLanguage) {
  ...
  **/
  ...
  public SourceCodeLoopUpdate sourceLanguageVersion(String sourceLanguageVersion) {
  ...
  **/
  ...
  public SourceCodeLoopUpdate loopName(String loopName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SourceCodeLoopUpdate sourceCodeLoopUpdate = (SourceCodeLoopUpdate) o;
    return Objects.equals(this.metadataType, sourceCodeLoopUpdate.metadataType) &&
        Objects.equals(this.sourceLanguage, sourceCodeLoopUpdate.sourceLanguage) &&
        Objects.equals(this.sourceLanguageVersion, sourceCodeLoopUpdate.sourceLanguageVersion) &&
        Objects.equals(this.loopName, sourceCodeLoopUpdate.loopName) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceCodeLoopUpdate {\n");
