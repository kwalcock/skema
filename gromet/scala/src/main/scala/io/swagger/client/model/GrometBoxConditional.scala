 ...
 *
 * @param name 
 * @param condition The index to the entry in the `bf` table (array) of *this* GrometFN representing the conditional condition. 
 * @param bodyIf The index to the entry in the `bf` table (array) of *this* GrometFN representing the body (Function) of IF-branch of the conditional. 
 * @param bodyElse The index to the entry in the `bf` table (array) of *this* GrometFN representing the body (Function) of ELSE-branch of the conditional. 
 */
case class GrometBoxConditional (
  name: Option[String] = None,
  condition: Option[Integer] = None,
  bodyIf: Option[Integer] = None,
  bodyElse: Option[Integer] = None
)
